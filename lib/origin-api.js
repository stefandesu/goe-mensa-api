...
const baseUri = "https://phpapp2.zvw.uni-goettingen.de/portlet_mensaplan/public/ajaxresponse/getgerichte?tag=uebermorgen"

// Date as ISO string
let currentDate = new Date()
currentDate.setDate(currentDate.getDate() + 2)
// If date will be a Sunday, add one more day
